				...
				<div id="content_timeline">
					...
					<table>
						...
						<tr>
							...
							<td>
							<input type="text" name="u_name" required="required" value="<?php echo $username;?>"/>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
							<input type="email" name="u_email" required="required" value="<?php echo $email;?>"></td>
						</tr>
...
<?php 
	if(isset($_POST['update'])){
		...
		$update = "update users set username='$u_name', email='$u_email', img='$u_image' where user_id='$user_id'";
